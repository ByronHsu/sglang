...
class TestMamba(unittest.TestCase):
    ...
    def test_mamba_radix_partial_page_match_does_not_split(self):
        page_size = 64
        ...
        match = tree.match_prefix(
            MatchPrefixParams(key=RadixKey(token_ids[: page_size - 1], None))
        )
    ...
    @staticmethod
    def _setup_minimal_mamba_radix_cache(page_size: int) -> MambaRadixCache:
    ...
    @staticmethod
    def _non_root_key_lengths(tree: MambaRadixCache) -> list[int]:
        lengths = []
